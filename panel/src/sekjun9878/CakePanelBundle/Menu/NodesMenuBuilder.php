...
class NodesMenuBuilder extends ContainerAware{
	...
	public function sideMenu(FactoryInterface $factory, array $options)
	{
		...
		$menu->addChild('Nodes', array('route' => 'sekjun9878_cake_panel_nodes'));
		$menu->addChild('Add Node', array('route' => 'sekjun9878_cake_panel_nodes_add'));
